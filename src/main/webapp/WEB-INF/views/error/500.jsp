...
<html lang="zh-cn">
	<head>
		...
		<link rel="stylesheet" href="${ctx}/static/ace_static/assets/css/ace.onpage-help.css" />
		<link rel="stylesheet" href="${ctx}/static/ace_static/docs/assets/js/themes/sunburst.css" />
	...
	<body class="no-skin">
					...
					<ul class="nav ace-nav">
									...
									<ul class="dropdown-menu dropdown-navbar">
										<li>
											<a href="#" class="clearfix">
												<img src="${ctx}/static/ace_static/assets/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
												<span class="msg-body">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="${ctx}/static/ace_static/assets/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="${ctx}/static/ace_static/assets/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="${ctx}/static/ace_static/assets/avatars/avatar2.png" class="msg-photo" alt="Kate's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="${ctx}/static/ace_static/assets/avatars/avatar5.png" class="msg-photo" alt="Fred's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="${ctx}/static/ace_static/assets/avatars/user.jpg" alt="Jason's Photo" />
		...
		<!--[if !IE]> -->
		<script type="text/javascript">
			window.jQuery || document.write("<script src='${ctx}/static/ace_static/assets/js/jquery.js'>"+"<"+"/script>");
		</script>
		...
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='${ctx}/static/ace_static/assets/js/jquery1x.js'>"+"<"+"/script>");
</script>
<![endif]-->
		<script type="text/javascript">
		...
		<script src="${ctx}/static/ace_static/assets/js/ace/elements.onpage-help.js"></script>
		<script src="${ctx}/static/ace_static/assets/js/ace/ace.onpage-help.js"></script>
		<script src="${ctx}/static/ace_static/docs/assets/js/rainbow.js"></script>
		<script src="${ctx}/static/ace_static/docs/assets/js/language/generic.js"></script>
		<script src="${ctx}/static/ace_static/docs/assets/js/language/html.js"></script>
		<script src="${ctx}/static/ace_static/docs/assets/js/language/css.js"></script>
		<script src="${ctx}/static/ace_static/docs/assets/js/language/javascript.js"></script>
	</body>
</html>
