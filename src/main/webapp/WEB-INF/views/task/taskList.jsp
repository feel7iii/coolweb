				...
				<div class="nav-search" id="nav-search">
					<form class="form-search" action="#">
						<span class="input-icon">
							<input type="text" name="search_LIKE_title" placeholder="Search ..." class="nav-search-input" id="nav-search-input" autocomplete="off" />
							<button type="submit"><i class="ace-icon fa fa-search nav-search-icon"></i></button>
						</span>
					</form>
				</div>
			</div>
